    ...
    <main className="min-h-screen bg-gradient-to-br from-white to-brand-light dark:from-brand-dark dark:to-gray-900">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-3xl mx-auto prose dark:prose-invert">
          ...
          <h2>Introduction</h2>
          <p>
            Luxyana ("we" or "us" or "our") operates the Luxyana website and apps. This page informs you of our policies 
            regarding the collection, use, and disclosure of personal data when you use our services and the choices you 
          ...
          <ul>
            <li><strong>Personal Data:</strong> Email address (if you subscribe to our newsletter)</li>
          ...
          <h2>Contact Us</h2>
          <p>
            If you have any questions about this Privacy Policy, please contact us at hello@luxyana.com
          </p>
